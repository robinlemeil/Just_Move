...
public class Page_Principale extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articles_justmove.add(new Article("Faire du sport", "sport", "Est-ce nécessaire de boire beaucoup d'eau après un footing?"));
        articles_justmove.add(new Article("Mieux bouger", "etirements", "Voici 5 étirements à réaliser sans matériel"));
        articles_justmove.add(new Article("Posture au travail", "siege", "Qu'est-ce qu'une bonne chaise de bureau?"));
